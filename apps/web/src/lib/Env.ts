...
const rawEnv = {
  ...
  NEXT_PUBLIC_WATCH_NOW_PIT_WINDOW_GAP_SECONDS:
    process.env.NEXT_PUBLIC_WATCH_NOW_PIT_WINDOW_GAP_SECONDS,
  NEXT_PUBLIC_WATCH_NOW_PIT_WINDOW_MIN_TIRE_AGE:
    process.env.NEXT_PUBLIC_WATCH_NOW_PIT_WINDOW_MIN_TIRE_AGE,
...
export const getWatchNowDetectorConfig = (): WatchNowDetectorConfig => {
  ...
  return {
    ...
    pitWindowGapThresholdSeconds:
      env.NEXT_PUBLIC_WATCH_NOW_PIT_WINDOW_GAP_SECONDS,
    pitWindowMinTireAgeLaps: env.NEXT_PUBLIC_WATCH_NOW_PIT_WINDOW_MIN_TIRE_AGE,
