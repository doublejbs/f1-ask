...
type PersistedRaceRuntimeState = {
  ...
  overrideRangeState: Record<string, boolean>;
...
- 0.1초 미만의 단일 gap 변화
- 같은 랩에서 반복되는 오버라이드 사정권 진입과 이탈 진동
